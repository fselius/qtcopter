...
def find_coords(distance, pixel_width, pixel_height, x_pixel, y_pixel, x_os, y_os):#, focal_length):
...
def main():
    ...
    print find_coords(distance, pixel_width, pixel_height, x_pixel, y_pixel, x_os, y_os)            
